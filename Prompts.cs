...
{
    public static string ChatName { get; set; } = "Verzin een naam voor deze chat. Gebruik maximaal 1-4 woorden. Gebruik nooit de naam Fakton. Geef in je antwoord alleen de naam en voeg geen andere tekst toe.";
